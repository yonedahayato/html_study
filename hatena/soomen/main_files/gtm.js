...
return null},xd=!1;if(H.querySelectorAll)try{var yd=H.querySelectorAll(":root");yd&&1==yd.length&&yd[0]==H.documentElement&&(xd=!0)}catch(a){}var rd=xd;var Md={},K=null,Nd=Math.random();Md.C="GTM-P4CXTW";Md.Rb="871";Md.Ih="";var Od={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Pd="www.googletagmanager.com/gtm.js";
var Qd=Pd,Rd=null,Sd=null,Td="//www.googletagmanager.com/a?id="+Md.C+"&cv=187",Ud={},Vd={},Wd=function(){var a=K.sequence||1;K.sequence=a+1;return a};
...
Z.a.gaawe=["google"],function(){function a(b,c,d){for(var e=0;e<c.length;e++)b.hasOwnProperty(c[e])&&(b[c[e]]=d(b[c[e]]))}(function(b){Z.__gaawe=b;Z.__gaawe.b="gaawe";Z.__gaawe.g=!0;Z.__gaawe.priorityOverride=0})(function(b){var c=String(b.vtp_measurementIdOverride||b.vtp_measurementId),d=String(b.vtp_eventName);if("_"===d.charAt(0))I(b.vtp_gtmOnFailure);else{var e={};p(wm(b.vtp_eventParameters,"name","value"),e);if(e.hasOwnProperty(C.la)||b.vtp_userProperties){var f=e[C.la]||{};p(wm(b.vtp_userProperties,
"name","value"),f);e[C.la]=f}oo(e);a(e,C.xe,function(h){return Fa(h)});a(e,C.De,function(h){return Number(h)});Qj(d,e,c);I(b.vtp_gtmOnSuccess)}})}();Z.a.ctv=["google"],function(){(function(a){Z.__ctv=a;Z.__ctv.b="ctv";Z.__ctv.g=!0;Z.__ctv.priorityOverride=0})(function(){return"187"})}();
...
f(l)||c()}else c()},e=function(){U(b,d,c)};hd()?qd(function(){od(C.m)?e():kd(e,C.m)},[C.m]):(mh(),e())})}();Z.a.c=["google"],function(){(function(a){Z.__c=a;Z.__c.b="c";Z.__c.g=!0;Z.__c.priorityOverride=0})(function(a){return a.vtp_value})}();
...
Z.a.tg=["google"],function(){function a(k){h.push(k);1<h.length||I(function(){var l=h.join(",");h=[];Il({event:"gtm.triggerGroup","gtm.triggers":l})})}function b(k,l){var n=d[l],m=n.indexOf(k);-1!==m&&(n.splice(m,1),n.length||a(l))}function c(k){I(k.vtp_gtmOnSuccess);var l=k.vtp_uniqueTriggerId,n=k.vtp_triggerIds,m=k.vtp_firingId;if(k.vtp_isListeningTag){var r=e[m];r?b(m,r):f.push(m)}else{d[l]=n;for(var t=0,q;q=n[t];t++)e[q]=l;for(var u=0;u<f.length;u++)b(f[u],l)}}var d={},e={},f=[],h=[];Z.__tg=c;Z.__tg.b="tg";Z.__tg.g=!0;Z.__tg.priorityOverride=0}();
...
t.value)};k(Q,M,!1);D("send",M);}else if("TRACK_SOCIAL"==m.vtp_trackType){}else if("TRACK_TRANSACTION"==m.vtp_trackType){
D("require","ecommerce","//www.google-analytics.com/plugins/ua/ecommerce.js");var S=function(na){return Hl("transaction"+na,1)},ea=S("Id");D("ecommerce:addTransaction",{id:ea,affiliation:S("Affiliation"),revenue:S("Total"),shipping:S("Shipping"),tax:S("Tax")});for(var V=S("Products")||[],wa=0;wa<V.length;wa++){var la=V[wa];D("ecommerce:addItem",{id:ea,sku:la.sku,name:la.name,category:la.category,price:la.price,quantity:la.quantity})}D("ecommerce:send");}else if("TRACK_TIMING"==
